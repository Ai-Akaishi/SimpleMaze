...
execute if data storage simple_maze: maze[-1][-1] run function simple_maze:6/build/x

## 繰り返し処理
data remove storage simple_maze: maze[-1]
##                                                            #
execute if data storage simple_maze: maze[-1] positioned ~ ~ ~2.5 run function simple_maze:6/build/z

...
execute if data storage simple_maze: maze[-1][-1] run function simple_maze:5/build/x

## 繰り返し処理
data remove storage simple_maze: maze[-1]
##                                                            #
execute if data storage simple_maze: maze[-1] positioned ~ ~ ~2.0 run function simple_maze:5/build/z
